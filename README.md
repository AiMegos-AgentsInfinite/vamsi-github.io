...
- **AI in QA Testing and Automation**, **LLMs Benchmarking**
...
- **Cloud & Tools:** Microsoft Azure OpenAI, ---
...
### 💻 Technical Expertise
- **AI/ML:** Gen AI, AI MultiAgents, AiBots, Deep Learning, TinyML
- **Cloud & Tools:** Microsoft Azure AI, Azure OpenAI / ---
...
### 💻 Technical Expertise
- **AI/ML:** Gen AI, AI MultiAgents, AiBots, Deep Learning, TinyML
- **Cloud & Tools:** **Microsoft Azure AI, Azure OpenAI / AI Foundry**, Microsfot **Power Automate**, Power Apps, Microsoft Power Bi, Microsoft IoT, Azure DevOps, **Docker**, **Kubernetes**
...
, Microsfot Power Automate, Power Apps Azure, Microsoft Power Bi, Microsoft IoT, Azure DevOps, **Docker**, **Kubernetes**
- **Development:** Python, C#, .NET Framework, Selenium, RestSharp API
- **Platforms:** Power Platform, Power Apps, Power BI, Microsoft Copilot Studio, M365 Copilot, Microfost Dynamics 365 Copilot, Poe.
- **Specialties:** Computer Vision, NLP, RPA, QA Automation
- **Data:** Data Science, Data Analytics, Predictive Modeling
...
- [Microsoft Credentials](https://learn.microsoft.com/en-us/users/kethuvamsi-aiml/transcript/v0306i32e25382l)
- [Salesforce Trailhead Mountaineer](https://www.salesforce.com/trailblazer/vkethu)
, Microsfot **Power Automate**, Power Apps, Microsoft Power Bi, Microsoft IoT, Azure DevOps, **Docker**, **Kubernetes**
- **Development:** Python, C#, .NET Framework, Selenium, RestSharp API
- **Platforms:** Power Platform, Power Apps, Power BI, Microsoft Copilot Studio, M365 Copilot, Microfost Dynamics 365 Copilot, Poe.
- **Specialties:** Computer Vision, NLP, RPA, QA Automation
- **Data:** Data Science, Data Analytics, Predictive Modeling
